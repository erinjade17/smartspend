...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        categoriesRecyclerView = view.findViewById(R.id.categoriesRecyclerView) // Initialize
        expensesRecyclerView = view.findViewById(R.id.expensesRecyclerView)    // Initialize
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        expenseAdapter = ExpenseAdapter(emptyList(), emptyList()) // Pass empty list initially
        ...
        viewModel.categories.observe(viewLifecycleOwner) { categories ->
            ...
            // Update ExpenseAdapter with categories
            expenseAdapter = ExpenseAdapter(viewModel.expenses.value ?: emptyList(), categories)
            expensesRecyclerView.adapter = expenseAdapter
        }
