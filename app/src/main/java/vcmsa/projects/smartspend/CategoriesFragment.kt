...
class CategoriesFragment : Fragment() {
    ...
    private fun showAddCategoryDialog() {
        ...
        val dialogView = inflater.inflate(R.layout.dialog_add_category, null) // Corrected layout reference
        builder.setView(dialogView)

        val categoryNameEditText = dialogView.findViewById<EditText>(R.id.categoryNameEditText) //Corrected reference
