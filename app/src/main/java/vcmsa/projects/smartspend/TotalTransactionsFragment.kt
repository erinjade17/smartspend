...
class TotalTransactionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Initialize expenseAdapter with empty lists
        expenseAdapter = ExpenseAdapter(emptyList(), emptyList())
        ...
        viewModel.expenses.observe(viewLifecycleOwner) { expenses ->
            // Update the expenseAdapter with the new expenses and categories
            expenseAdapter.updateExpenses(expenses)
        }

        // Observe the categories LiveData.  This is CRUCIAL.
